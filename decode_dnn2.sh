...
if [ $# != 5 ]; then
   ...
   echo "Usage: steps/decode_dnn.sh [options] <graph-dir> <data-dir> <ali-dir> <decode-dir> <dnn.nnet-file>"
   echo " e.g.: steps/decode_dnn.sh exp/tri4/graph data/test exp/tri4_ali exp/tri4_dnn/decode exp/tri4_dnn/dnn.nnet"
...
dnn_file=$5
echo $0: Using DNN \file: $dnn_file
...
##
finalfeats="$feats nnet-forward --class-frame-counts=$dir/class.counts --apply-log=true --no-softmax=false $dnn_file ark:- ark:- |"
